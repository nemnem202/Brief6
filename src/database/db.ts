...
export const recipeInstructions: RecipeInstruction[] = [
  ...
  },
  {
    ...
    step: 3,
    description:
      "Garnissez le pain avec la préparation aux tomates et arrosez d'un filet d'huile d'olive.",
    recipeId: 101,
  },
  // Salade Grecque (102)
  {
  ...
  },
  {
    ...
    step: 2,
    description:
      "Mélangez le yaourt avec l'ail haché, l'huile d'olive et le concombre bien essoré.",
    recipeId: 106,
  },
  ...
  // Poulet Rôti (202)
  {
    ...
    step: 1,
    description:
      "Préchauffez le four à 200°C. Massez le poulet avec le beurre, l'ail et les herbes.",
    recipeId: 202,
  },
  {
    id: 23,
  ...
  { id: 25, step: 1, description: "Préparez la sauce bolognaise et la béchamel.", recipeId: 203 },
  {
    ...
    step: 2,
    description:
      "Montez les lasagnes en alternant les couches : pâtes, bolognaise, béchamel, parmesan.",
    recipeId: 203,
  },
  {
    id: 27,
    step: 3,
    description:
      "Terminez par une couche de béchamel et de parmesan, puis enfournez 30 minutes à 180°C.",
    recipeId: 203,
  },
  // Hachis Parmentier (204)
  ...
  // Gâteau au Yaourt (305)
  {
    ...
    step: 1,
    description:
      "Mélangez tous les ingrédients dans l'ordre : yaourt, sucre, œufs, farine, levure, huile.",
    recipeId: 305,
  },
...
export const recipeComments: RecipeComment[] = [
  ...
  },
  {
    ...
    content:
      "Pas fan de la feta utilisée, une prochaine fois j'en prendrai une de meilleure qualité.",
    note: 2,
  ...
  },
  {
    ...
    username: "MamaGato",
    content:
      "J'ai laissé cuire 2 minutes de trop et c'était un moelleux, pas un fondant. Bon quand même !",
    note: 3,
  ...
  },
  {
    ...
    username: "PastryFan",
    content:
      "La panna cotta se tenait parfaitement. Servie avec un coulis de mangue, c'était divin.",
    note: 5,
  ...
  },
  {
    ...
    username: "MarcEnCuisine",
    content:
      "Recette parfaite. J'ai utilisé de la vergeoise pour caraméliser, c'est encore meilleur.",
    note: 5,
